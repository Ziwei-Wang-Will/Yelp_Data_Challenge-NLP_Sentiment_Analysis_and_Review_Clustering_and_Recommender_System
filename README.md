...
- What were the key features (words) that made the positive prediction?(Generated by **Logistic Regression** Classifier)
    - <img src="https://github.com/will-zw-wang/Yelp_Data_Challenge-NLP_Sentiment_Analysis_and_Review_Clustering_and_Recommender_System/blob/master/images/sentiment%20classification/top_words_positive_review_by_LR.png" width="120" height="400">
...
- What were the key features (words) that made the negative prediction?(Generated by **Logistic Regression** Classifier)
    - <img src="https://github.com/will-zw-wang/Yelp_Data_Challenge-NLP_Sentiment_Analysis_and_Review_Clustering_and_Recommender_System/blob/master/images/sentiment%20classification/top_words_negative_review_by_LR.png" width="120" height="400">
